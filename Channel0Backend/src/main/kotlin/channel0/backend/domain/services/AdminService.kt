...
import channel0.backend.data.dto.request.ShowRequest
import channel0.backend.data.entities.global.ChannelEntity
import channel0.backend.data.entities.global.ChannelShowEntity
import channel0.backend.data.entities.global.ChannelShowId
import channel0.backend.data.entities.global.EpisodeEntity
import channel0.backend.data.entities.global.SeasonEntity
import channel0.backend.data.entities.global.SegmentEntity
...
import channel0.backend.data.repositories.ShowRepository
import channel0.backend.domain.validation.validate
...
class AdminService(
    ...
    private fun processShows(
        ...
        shows.forEachIndexed { index, showReq ->
            ...
            // 🔥 THIS is what your playback depends on
